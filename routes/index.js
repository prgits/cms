...
module.exports = function (app, passport) {
    ...
    app.get('/post/category', isAuthenticated, postController.getCategory);

    app.get('/category/:type', isAuthenticated, categoryController.getIndex);

    app.get('/category/create/:type', isAuthenticated, categoryController.getCreate);

    app.post('/category/create', isAuthenticated, categoryController.postCreate);
